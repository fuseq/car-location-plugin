...
class CarLocationPlugin extends CLPCore {
    ...
    initPicker() {
        ...
        this.picker.init('clp', [
            { 
                id: 'floor', 
                elementId: 'clp-col-floor', 
                contentId: 'clp-content-floor', 
                data: this.getFloorsForPicker(),
                defaultValue: this.selectedFloor
            },
            { 
                id: 'column', 
                elementId: 'clp-col-column', 
                contentId: 'clp-content-column', 
                data: this.getColumnsForPicker(),
                defaultValue: this.selectedColumn
            },
            { 
                id: 'number', 
                elementId: 'clp-col-number', 
                contentId: 'clp-content-number', 
    ...
    updatePickerResult() {
        const resultEl = document.getElementById('clp-picker-result');
        if (!resultEl) return;
    ...
    bindEvents() {
        // Save button
        document.getElementById('clp-save-btn')?.addEventListener('click', () => this.save());

        // Camera button
        const cameraBtn = document.getElementById('clp-camera-btn');
        const photoInput = document.getElementById('clp-photo-input');
    ...
    async save() {
        const noteInput = document.getElementById('clp-note-input');
    ...
    renderParkingList() {
        const listEl = document.getElementById('clp-parking-list');
        if (!listEl) return;
